...
export const LISTENING_TESTS: ListeningTest[] = [
  {
    ...
    level: "Band 5.5–6.5",
    imageUrl:
      "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 580 240' width='100%' height='100%'><rect width='580' height='240' rx='12' fill='%230f172a'/><text x='290' y='28' fill='%23f8fafc' font-family='system-ui, sans-serif' font-size='15' font-weight='bold' text-anchor='middle'>Riverside Community Garden Site Map</text><rect x='30' y='100' width='70' height='36' rx='6' fill='%23334155' stroke='%2394a3b8' stroke-width='2'/><text x='65' y='122' fill='%23f8fafc' font-family='system-ui, sans-serif' font-size='11' font-weight='bold' text-anchor='middle'>Main Gate</text><line x1='100' y1='118' x2='480' y2='118' stroke='%2364748b' stroke-width='6' stroke-dasharray='10 5'/><rect x='140' y='45' width='120' height='55' rx='6' fill='%2314532d' stroke='%2322c55e' stroke-width='2'/><text x='200' y='77' fill='%234ade80' font-family='system-ui, sans-serif' font-size='11' font-weight='bold' text-anchor='middle'>Plots A & B (Vegetables)</text><rect x='280' y='45' width='120' height='55' rx='6' fill='%231e3a8a' stroke='%233b82f6' stroke-width='2'/><text x='340' y='77' fill='%2360a5fa' font-family='system-ui, sans-serif' font-size='11' font-weight='bold' text-anchor='middle'>Greenhouse & Seeds</text><rect x='140' y='140' width='120' height='55' rx='6' fill='%2378350f' stroke='%23f59e0b' stroke-width='2'/><text x='200' y='172' fill='%23fbbf24' font-family='system-ui, sans-serif' font-size='11' font-weight='bold' text-anchor='middle'>Compost Bins</text><rect x='280' y='140' width='120' height='55' rx='6' fill='%23581c87' stroke='%23a855f7' stroke-width='2'/><text x='340' y='172' fill='%23c084fc' font-family='system-ui, sans-serif' font-size='11' font-weight='bold' text-anchor='middle'>Tool Container</text></svg>",
    imageAlt: "Riverside Community Garden Site Map Layout",
    transcript: [
